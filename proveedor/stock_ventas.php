...
echo "<table border='1' cellpadding='6' cellspacing='0'>
        <tr><th>Pedido</th><th>Fecha</th><th>Cantidad</th><th>Precio base</th></tr>";
foreach ($sales as $sale) {
  echo "<tr><td>".h((string)$sale['order_id'])."</td><td>".h($sale['created_at'] ?? '')."</td><td>".h((string)$sale['qty_allocated'])."</td><td>".h((string)$sale['unit_base_price'])."</td></tr>";
}
echo "</table>";
